...
**REQUIRED:** For every new session, read these files IN ORDER before responding to any queries:

1. **~/.claude/working-agreements.md** - General instructions on Claude and user work together (ALWAYS read this first)
2. **Project-level documentation** - Read all project files in the project directory:
   - **architecture.md** - System design and technical architecture
   - **decisions-and-learnings.md** - Technical decisions, lessons learned, and gotchas
   - **planning.md** - Current work, task tracking, and progress

## Standard Project File Structure

Every project follows this consistent documentation pattern:

- **CLAUDE.md** - Project specific context and working agreements, and authoritative source for other contextualization files within project.
- **architecture.md** - System design, technical architecture, and structure
- **decisions-and-learnings.md** - Technical decisions, lessons learned, and gotchas
- **planning.md** - Current work, task tracking, and progress (task-specific)

---

**Note**: Project-specific CLAUDE.md files extend and customize these global patterns.
