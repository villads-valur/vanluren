...
-- Diagnostic keymaps
vim.keymap.set('n', 'lp', vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message' })
vim.keymap.set('n', 'ln', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
...
-- Split management
vim.keymap.set('n', '<leader>v', ':vsplit<CR>', { desc = 'Split Window' })

-- Neotree
vim.keymap.set('n', '<leader>n', ':Neotree toggle<CR>', { desc = 'Open Neotree' })

-- General
vim.keymap.set('n', '<leader>w', ':w<CR>', { desc = 'Open Neotree' })

-- Buffer management
vim.keymap.set('n', '<leader>bd', ':BD<CR>', { desc = '[B]uffer [D]elete' })
vim.keymap.set('n', '<Tab>bd', ':BD<CR>', { desc = '[B]uffer [D]elete' })
